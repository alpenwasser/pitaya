...
\clearpage
To make up for the finite window size of the measured signal, the signal can be multiplied with a windowing function to correct the blurred spectrum.
We can do this by applying known windows such as a Hanning or a Blackman window as shown in Figure~\ref{eq:gui:window}.
