...
key  characteristics  which are  of  interest  to us. From  that  information,
the  objectives of  this  project are  derived. Possible  approaches to  reach
those  objectives are  presented  and  evaluated, and  a  decision is  reached
on  how  to  achieve  this  project's   aims. At  the  end  of  this  chapter,
the  reader  will know  what  we  intend to  do  and  why. For the  impatient,
Section~\ref{subsec:concept:summary}  on page~\pageref{subsec:concept:summary}
contains a summary of our findings and decisions from this chapter.
