...
This script loads the kernel module and sets the \code{LD\_LIBRARY\_PATH} variable such that it can load the shared libraries required. The script can be executed with
\begin{commandshell}
...
For the exact commands, please have a look into the \code{init\_server.sh} script.
