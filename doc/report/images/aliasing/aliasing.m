...
% plot(f,Y1);hold on;
Y2 = [zeros(1,(overall_length)/2 - (length(Y))/2) Y zeros(1,(overall_length)/2 - (length(Y))/2)];
% plot(f,Y2)
...
dlmwrite(...
    plotFile,...
    [(-length(Y1)/2:1:length(Y1)/2-1)', Y1'],...
    '-append',...
    'delimiter', ',',...
    'newline', 'unix'...
);
...
dlmwrite(...
    plotFile,...
    [(-length(Y2)/2:1:length(Y2)/2-1)', Y2'],...
    '-append',...
    'delimiter', ',',...
    'newline', 'unix'...
);
...
dlmwrite(...
    plotFile,...
    [(-length(Y3)/2:1:length(Y3)/2-1)', Y3'],...
    '-append',...
    'delimiter', ',',...
    'newline', 'unix'...
);